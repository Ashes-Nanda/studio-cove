...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Studio — Studio Cove",
    description: "Philosophy, process, and the work between the work.",
    images: [dyskoRoom],
  },
};
    ...
    <>
      <section className="pt-40 pb-24 px-6 bg-paper">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-ink/70 leading-relaxed max-w-2xl">
            We build brands across F&amp;B, FMCG, fashion, art, and tech — brands that need a point
            of view, not just a posting schedule.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-ink text-paper">
        <div className="max-w-5xl mx-auto">
          <p className="font-mono text-[10px] uppercase text-accent mb-12">[ Manifesto ]</p>
          <div className="space-y-10 text-2xl md:text-3xl font-display italic leading-tight text-pretty">
            <p>
              <span className="text-accent">One —</span> Culture is the brief. Brands that ignore it
              disappear.
            </p>
            <p>
              <span className="text-accent">Two —</span> A brand is a world, not a logo. We build
              the whole room.
            </p>
            <p>
              <span className="text-accent">Three —</span> The feed is a publication. Treat it like
              one.
            </p>
            <p>
      ...
      <section className="py-24 px-6 bg-paper">
        <div className="max-w-7xl mx-auto">
          <p className="font-mono text-[10px] uppercase text-accent mb-12">[ From the floor ]</p>
          <div className="grid grid-cols-12 gap-6">
            ...
            <img
              ...
              alt=""
              loading="lazy"
              className="col-span-6 md:col-span-4 md:mt-24 w-full aspect-[3/4] object-cover ring-1 ring-black/5"
            />
            <img
              src={chinitaChef}
              alt=""
              loading="lazy"
              className="col-span-6 md:col-span-5 md:col-start-3 w-full aspect-[4/5] object-cover ring-1 ring-black/5 mt-12"
            />
            <img
              src={kalpaPortrait}
              alt=""
              loading="lazy"
              className="col-span-12 md:col-span-6 w-full aspect-[4/5] object-cover ring-1 ring-black/5 mt-12"
            />
          </div>
        </div>
      </section>
